...
//      },
  ...
  methods: {
    ...
    getList () {
      ...
      this.$http.post('/api/getOrderList', reqParams)   //传参数
      .then((res) => {
    ...
    changeOrderType (headItem) {
      this.tableHeads.map((item) => {
        item.active = false     //将其他active变为false
        return item
      })
      headItem.active = true        //再将该item active转为true
